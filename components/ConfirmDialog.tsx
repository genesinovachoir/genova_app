      ...
      {open ? (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-4 bottom-[calc(2rem+env(safe-area-inset-bottom))] z-[221] mx-auto max-w-md rounded-[var(--radius-panel)] border border-[var(--color-border)] bg-[var(--color-surface-solid)] p-5 shadow-2xl"
          >
